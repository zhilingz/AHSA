...
- build skill and metadata dataset

### phase 2

- implement profile generation
- improve semantic generalization
...
This repository is a minimal prototype aligned with the AHSA proposal.

It currently includes:

- dataset construction
- llm-based policy compilation
- runtime policy enforcement

It does not yet include:

- full trace-run infrastructure
- semantic profile generalization beyond current prompt output
- hitl approval flow
